...
%
% Used by tera_relerr_hinf_reduced.m to unfold a reduced T-ERA system's
% (A,B,C) tensors into an ordinary state-space (matrix) system for an
% exact H-infinity norm via the Control System Toolbox's hinfnorm().
%
